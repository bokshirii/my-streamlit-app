...
index c3b80f4a7f723830f1f42f6c126b584b375578f0..8e237abc4ef7a2c165857ede0b3b3f5c633cf467 100644
--- a/app.py
+++ b/app.py
@@ -1,158 +1,28 @@
...
-    "코미디": [35],
-}
+def suggest_action(goal: str) -> str:
+    cleaned = goal.strip().strip('"').strip("'")
+    return f"'{cleaned}'을(를) 위해 5~10분 안에 할 수 있는 가장 작은 첫 행동 한 가지를 한 줄로 적기."
